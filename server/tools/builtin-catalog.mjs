...
export const TOOL_PRESETS = {
  'read-only': ['read', 'grep', 'find', 'ls', 'web_search', 'browser_automation', 'memory_search', 'memory_remember', 'delegate_task', 'mcp_list', 'mcp_manage'],
  workspace: ['read', 'grep', 'find', 'ls', 'edit', 'write', 'web_search', 'browser_automation', 'memory_search', 'memory_remember', 'delegate_task', 'mcp_list', 'mcp_manage'],
  full: ['read', 'grep', 'find', 'ls', 'edit', 'write', 'bash', 'web_search', 'browser_automation', 'memory_search', 'memory_remember', 'delegate_task', 'mcp_list', 'mcp_manage'],
}
